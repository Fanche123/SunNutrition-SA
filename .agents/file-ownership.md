...
Las pruebas propias pertenecen al implementador y no se duplican en el Coordinador. En alto riesgo, `watchdog_tarea`, tres instancias focalizadas de `validador_tarea` y `consolidador_validacion` son controles read-only internos sin ownership funcional.
