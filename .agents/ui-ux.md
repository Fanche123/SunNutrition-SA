...
- `#view-purchase-entry` muestra arriba una lista compacta de la misma fotografía de Inventario; es informativa y no modifica, filtra ni limita el selector libre del formulario.
